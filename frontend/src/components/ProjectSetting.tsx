    ...
    <div className="p-6 min-h-screen flex-1 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 uppercase">{project.status}</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-xl p-6 space-y-6 border border-gray-200 dark:border-gray-700">
        ...
        <div>
          <label className="block mb-1 font-medium">Progress: {project.progress}%</label>
      ...
      {/* Team Members */}
      <div className="mt-6 bg-white dark:bg-gray-800 shadow rounded-xl p-6 border border-gray-200 dark:border-gray-700">
